    ...
    try:
        with open("arquivos_cadastro/cadastro_cliente.txt", "r") as arquivo:
            ...
            if not clientes:
                ...
                escolha = input(
                    "Deseja cadastrar um novo cliente  (1- Sim/ 2- Voltar ao Menu / 3- Sair) "
                )
                while escolha != "3":
                    if escolha == "1":
                        cadastro_cliente_txt()
        ...
        escolha = input(
            "Arquivo Criado! Já que está vazio, deseja cadastrar um novo cliente? (1- Sim/ 2- Voltar ao Menu / 3- Sair) "
        )
        while escolha != "3":
            if escolha == "1":
                cadastro_produto_txt()
                ...
                print("Insira uma escolha válida")
            escolha = input(
                "Deseja cadastrar um cliente? (1- Sim/ 2- Voltar ao Menu / 3- Sair) "
            )
    ...
    try:
        with open("arquivos_cadastro/cadastro_produto.txt", "r") as arquivo:
            ...
            if not produtos:
                ...
                escolha = input(
                    "Deseja cadastrar um novo produto? (1- Sim / 2- Voltar ao Menu / 3- Sair) "
                )
                while escolha != "3":
                    if escolha == "1":
                        cadastro_produto_txt()
        ...
        escolha = input(
            "Arquivo Criado! Já que está vazio, deseja cadastrar um novo produto? (1- Sim/ 2- Voltar ao Menu / 3- Sair) "
        )
        while escolha != "3":
            if escolha == "1":
                cadastro_produto_txt()
    ...
    try:
        with open("arquivos_cadastro/cadastro_pedido.txt", "r") as arquivo:
            ...
            if not pedidos:
                ...
                escolha = input(
                    "Deseja cadastrar um novo pedido? (1- Sim / 2- Voltar ao Menu / 3- Sair) "
                )
                while escolha != "3":
                    if escolha == "1":
                        cadastro_produto_txt()
        ...
        escolha = input(
            "Arquivo Criado! Já que está vazio, deseja cadastrar um novo pedido? (1- Sim/ 2- Voltar ao Menu / 3- Sair) "
        )
        while escolha != "3":
            if escolha == "1":
                cadastro_pedido_txt()
...
def consultar_pedidos_geral():
    ...
    if pedidos:
        ...
        for pedido in pedidos:
            ...
            print(
                f"ID Pedido: {id_pedido}, ID Cliente: {id_cliente}, Data do Pedido: {data_formatada}, Status do Pedido: {pedido_status}, Valor Total: R${total_pedido}"
            )
    else:
        ...
        with open("arquivos_cadastro/cadastro_pedido.txt", "r") as arquivo:
            for linha in arquivo:
                ...
                if id_pedido == buscar:
                    total_pedido = calcular_total_pedido(id_pedido)
                    data_formatada = (
                        f"{data_pedido[0:2]}/{data_pedido[2:4]}/{data_pedido[4:]}"
                    )
                    print(
                        f"ID Pedido: {id_pedido}, ID Cliente: {id_cliente}, Data do Pedido: {data_formatada}, Status do Pedido: {pedido_status}, Valor Total: R${total_pedido}"
                    )
